...
if(!Boolean.TRUE.equals(request.getAttribute("pageContextJavaScriptIncluded"))) {
	request.setAttribute("pageContextJavaScriptIncluded", Boolean.TRUE);
      ...
      out.write(".ly-pop{position:relative;width:441px;height:565px;}\r\n");
      ...
      out.write("\t<img src=\"/images/popup.jpg\" onclick=\"opener.location.href='/board/notice/view?no=110&page=0&searchKeyword='; self.close();\" style=\"cursor:pointer\" alt=\"\" />\r\n");
      out.write("\t<h1 class=\"blind\">근로자연극제 진행안내</h1>\r\n");
      out.write("\t<p class=\"blind\">\r\n");
      out.write("\t\t제37회 근로자연극제 진행 일정 안내 팝업입니다.\r\n");
      out.write("\t</p>\r\n");
      out.write("\t<a href=\"#\" class=\"btn-close\"><img src=\"/images/btn-close.png\" alt=\"닫기\" onclick=\"self.close();\" /></a>\r\n");
      out.write("\t<div class=\"chk-show\">\r\n");
      out.write("\t\t<input type=\"checkbox\" name=\"checkBox\" id=\"chk-pop\" /><label for=\"chk-pop\">24시간동안표시하지않음</label>\r\n");
      out.write("\t\t<a href=\"#\" onclick=\"notice_closeWin()\" class=\"txt-close\">닫기</a>\r\n");
      out.write("\t</div>\r\n");
