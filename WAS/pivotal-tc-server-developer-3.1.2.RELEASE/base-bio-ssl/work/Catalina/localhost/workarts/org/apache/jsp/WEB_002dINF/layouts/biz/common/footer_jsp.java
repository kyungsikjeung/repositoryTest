 ...
 * Generated at: 2016-02-04 11:21:26 UTC
...
if(!Boolean.TRUE.equals(request.getAttribute("pageContextJavaScriptIncluded"))) {
	request.setAttribute("pageContextJavaScriptIncluded", Boolean.TRUE);
      ...
      out.write("\t<img src=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/images/logo-footer.png\" alt=\"근로자문화예술제\" class=\"fl\">\r\n");
      out.write("\t<div class=\"txt-ft fl\">\r\n");
      out.write("\t\t<span>서울시 마포구 매봉산로 45 KBS미디어센터 4층 문화행사팀</span>\r\n");
      out.write("\t\t<ul class=\"ofh\">\r\n");
      out.write("\t\t\t<li><span>전화</span><span class=\"ct\">02-6939-8198 (KBS미디어 문화행사팀)</span></li>\r\n");
      out.write("\t\t\t<li><span>팩스</span><span class=\"ct\">02-6939-8199</span></li>\r\n");
      out.write("\t\t\t<li><span>이메일</span><span class=\"ct\">art@kbsmedia.co.kr</span></li>\r\n");
      out.write("\t\t</ul>\r\n");
      out.write("\t\t<p class=\"txt-cp\">Copyright 2016 <span class=\"pt\">KBS Media</span> All Rights Reserved.</p>\r\n");
      out.write("\t</div><!-- //.txt-ft -->\r\n");
