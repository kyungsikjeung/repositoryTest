 ...
 * Generated at: 2016-06-15 04:29:27 UTC
...
if(!Boolean.TRUE.equals(request.getAttribute("pageContextJavaScriptIncluded"))) {
	request.setAttribute("pageContextJavaScriptIncluded", Boolean.TRUE);
      ...
      out.write("\t\t<label class=\"checkbox-inline\" style=\"padding-right: 10px;\">\r\n");
      out.write("\t\t\t<input type=\"checkbox\" name=\"mergeExcelCell\" data-bind=\"checked: isMergeExcelCell\" /> 세로셀 병합\r\n");
      out.write("\t\t</label>\r\n");
      ...
      out.write("\t\t\t\t<td data-bind=\"text: categoryGroupName\"></td>\r\n");
      out.write("\t\t\t\t<td data-bind=\"text: description\"></td>\r\n");
      ...
      out.write("\t\t\t\t<td data-bind=\"text: workName\"></td>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<div class=\"col-lg-3\"><input type=\"text\" class=\"form-control\" data-bind=\"value: festivalName\" disabled=\"disabled\"/></div>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"col-lg-1\"></div>\r\n");
      out.write("\t\t\t\t\t\t\t<label class=\"col-lg-2 control-label\">참가분야:</label>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"col-lg-3\"><input type=\"text\" class=\"form-control\" data-bind=\"value: categoryName\" disabled=\"disabled\"/></div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t<label class=\"col-lg-2 control-label\">참가상세분야:</label>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"col-lg-3\"><input type=\"text\" class=\"form-control\" data-bind=\"value: description\" disabled=\"disabled\"/></div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t<label class=\"col-lg-2 control-label\">수상이력:</label>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"col-lg-9\"><textarea class=\"form-control\" data-bind=\"value: awardHistory\" disabled=\"disabled\"></textarea></div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t<label class=\"col-lg-2 control-label\">작품명:</label>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"col-lg-9\"><input type=\"text\" class=\"form-control\" data-bind=\"value: workName\" disabled=\"disabled\"/></div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t<label class=\"col-lg-2 control-label\">작품설명:</label>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"col-lg-9\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<textarea name=\"workDesc\" class=\"form-control\" data-bind=\"value: workDesc\" disabled=\"disabled\" ></textarea>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t<label class=\"col-lg-2 control-label\" for=\"uploadedFile\">첨부 작품</label>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"col-lg-9\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<span class=\"form-control\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<a href=\"javascript:;\" data-bind=\"text: workFileName, click: $parent.downloadWorkFile\"></a>\r\n");
      out.write("\t\t\t\t\t\t\t\t</span>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"form-group\" data-bind=\"visible: $parent.isImageFile\">\r\n");
      out.write("\t\t\t\t\t\t\t<label class=\"col-lg-2 control-label\" for=\"uploadedFile\">작품 미리보기</label>\t\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"col-lg-9\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<img data-bind=\"attr: { src: $parent.imageFileUrl }\" style=\"text-align:center; height: 400px;\" />\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t<label class=\"col-lg-2 control-label\">작품 반환수령 방법:</label>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"col-lg-9\"><input type=\"text\" class=\"form-control\" data-bind=\"value: ART_WORK_RETURN_TYPE_CODE_MAP[workReturnType]\" disabled=\"disabled\"/></div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      ...
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/app/admin/applymng/art.js\"></script>\r\n");
      out.write("<script type=\"text/javascript\">\r\n");
      ...
      out.write(";\r\n");
      out.write("\tvar ART_WORK_RETURN_TYPE_CODE_MAP = ");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ART_WORK_RETURN_TYPE_CODE_MAP}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write(";\r\n");
      out.write("\tsetPageLocation(\"applymng/art\", \"미술제 신청서 관리\")\r\n");
      out.write("</script>\r\n");
