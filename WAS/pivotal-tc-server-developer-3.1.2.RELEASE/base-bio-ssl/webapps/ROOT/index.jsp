...
<body>
	<div id="container">
		...
		<!-- Header -->
		<div id="hdr"><span class="utility"><a href="http://www.pivotal.io/products/pivotal-tc-server" title="Pivotal tc Server">Pivotal tc Server</a></span><a href="http://www.pivotal.io/" title="Pivotal"><h1>Pivotal</h1></a></div>
		...
		<div id="content">
			...
			<div>
				...
				<ul>
					<li><a href="http://www.pivotal.io/products/pivotal-tc-server">Pivotal tc Server Product Details</a><br />The official home for the Pivotal tc Server.</li>
		...
		<div class="clearfix"></div>
		<div id="versions">
			Pivotal tc Server Developer Edition 3.1.2.RELEASE<br/>
			<% out.println(ServerInfo.getServerInfo()); %>
		</div>

		<div id="ftr">&copy; 2015 Pivotal Software, Inc. All rights reserved.</div>
	</div>
