 ...
 * Generated at: 2019-03-12 04:35:30 UTC
...
if(!Boolean.TRUE.equals(pageContext.getAttribute("pageContextJavaScriptIncluded"))) {
	pageContext.setAttribute("pageContextJavaScriptIncluded", Boolean.TRUE);
      ...
      out.write("\n");
      out.write("\n");
      out.write("<div class=\"table-responsive\" data-bind=\"with:summaryVM\">\n");
      out.write("\t<table class=\"table table-bordered\" data-bind=\"with:data\">\n");
      out.write("\t\t<thead>\n");
      out.write("\t\t\t<tr class=\"bg-blue\">\n");
      out.write("\t\t\t\t<th>협력업체명</th>\n");
      out.write("\t\t\t\t<th>담당자</th>\n");
      out.write("\t\t\t\t<th>연락처</th>\n");
      out.write("\t\t\t</tr>\n");
      out.write("\t\t</thead>\n");
      out.write("\t\t<tbody >\n");
      out.write("\t\t\t<!-- ko foreach: cc -->\n");
      out.write("\t\t\t<tr>\n");
      out.write("\t\t\t\t<td data-bind=\"text:index\"></td>\n");
      out.write("\t\t\t\t<td data-bind=\"text:kk\"></td>\n");
      out.write("\t\t\t\t<td data-bind=\"text:pp\"></td>\n");
      out.write("\t\t\t\t<td><button type=\"button\"  class=\"btn btn-primary btn-xs\" data-bind=\"click:$root.summaryVM.deleteCcObj.bind(null,this)\"><b><i class=\"icon-checkmark3\" ></i></b> 삭제</button></td>\n");
      out.write("\t\t\t</tr>\n");
      out.write("\t\t\t<!-- /ko -->\n");
      out.write("\t\t</tbody>\n");
      out.write("\t</table>\n");
      out.write("\t<button type=\"button\"  class=\"btn btn-primary btn-xs\" data-bind=\"click:cretaeCcObj\"><b><i class=\"icon-checkmark3\" ></i></b> 생성</button>\n");
      out.write("\n");
      out.write("\n");
      out.write("</div>\n");
      out.write("\n");
      ...
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("/app/test/test2.js\"></script>\n");
