 ...
 * Generated at: 2019-02-28 10:11:58 UTC
 * Note: The last modified time of this file was set to
 *       the last modified time of the source file after
 *       generation to assist with modification tracking.
 */
package org.apache.jsp.WEB_002dINF.views.system.commoncodemng;
...
public final class commoncodemng_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if(!Boolean.TRUE.equals(pageContext.getAttribute("pageContextJavaScriptIncluded"))) {
	pageContext.setAttribute("pageContextJavaScriptIncluded", Boolean.TRUE);
      ...
      out.write("\t\t\t\t\t<label class=\"control-label text-right\">메인코드</label> <input\n");
      out.write("\t\t\t\t\t\ttype=\"text\" class=\"form-control input-xs\" placeholder=\"메인코드\"\n");
      out.write("\t\t\t\t\t\tdata-bind=\"value: searchMainCode\">\n");
      out.write("\t\t\t\t</div>\n");
      out.write("\t\t\t\t<!-- 공통코드명  -->\n");
      out.write("\t\t\t\t<div class=\"col-md-3\">\n");
      out.write("\t\t\t\t\t<label class=\"control-label text-right\">메인코드명</label> <input\n");
      out.write("\t\t\t\t\t\ttype=\"text\" class=\"form-control input-xs\" placeholder=\"메인코드명\"\n");
      out.write("\t\t\t\t\t\tdata-bind=\"value: searchMainCodeName\">\n");
      out.write("\t\t\t\t</div>\n");
      out.write("\t\t\t\t<!-- 사용 여부  -->\n");
      out.write("\t\t\t\t<div class=\"col-md-3\">\n");
      out.write("\t\t\t\t\t<label class=\"control-label text-right\"></label> <select\n");
      ...
      out.write("\t<button class=\"btn btn-success btn-xs\" type=\"button\" data-bind=\"click: $root.onCreateClick\"><b><i class=\"icon-plus3\"></i></b> 공통코드정보 등록</button>\n");
      out.write("</div>\n");
      out.write("\n");
      out.write("<!--공통코드 상세  -->\n");
      out.write("<form class=\"form-horizontal edcApplPanel\" id=\"detailsForm\" action=\"#\" data-bind=\"visible: detailsVM.isVisible\">\n");
      out.write("\t<div class=\"panel panel-flat\" >\n");
      out.write("\t\t<div class=\"panel-heading\">\n");
      out.write("\t\t\t<h5 class=\"panel-title\"><i class=\"icon-clipboard6 position-left\"></i> 공통코드정보</h5>\n");
      out.write("\t\t\t<div class=\"heading-elements\">\n");
      out.write("\t\t\t\t<ul class=\"icons-list\">\n");
      out.write("\t\t\t\t\t<li><a data-action=\"collapse\"></a></li>\n");
      out.write("\t\t\t\t</ul>\n");
      ...
      out.write("\t\t\t\t\t\t<label class=\"col-md-2 control-label text-left\" for=\"mainCode\">공통코드<span class=\"essentialAsterisk\">*</span></label>\n");
      out.write("\t\t\t\t\t\t<div id=\"detailLeftSide\" class=\"col-md-6\">\n");
      out.write("\t\t\t\t\t\t\t<input name=\"mainCode\" class=\"form-control input-xs\" type=\"text\" placeholder=\"메인코드\" data-bind=\"value: mainCode\">\n");
      out.write("\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t<div class=\"form-group marginbottom10\">\n");
      ...
      out.write("\t\t\t\t\t<div class=\"form-group marginbottom10\">\n");
      out.write("\t\t\t\t\t\t<label class=\"col-md-2 control-label text-left\" for=\"mainCodeName\">공통코드명<span class=\"essentialAsterisk\">*</span></label>\n");
      out.write("\t\t\t\t\t\t<div class=\"col-md-6\">\n");
      out.write("\t\t\t\t\t\t\t<input name=\"mainCodeName\" class=\"form-control input-xs\" type=\"text\" placeholder=\"공통코드명\" data-bind=\"value: mainCodeName\">\n");
      out.write("\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t<div class=\"form-group marginbottom10\">\n");
      out.write("\t\t\t\t\t\t<label class=\"col-md-2 control-label text-left\" for=\"edcTm\">사용 여부<span class=\"essentialAsterisk\">*</span></label>\n");
      out.write("\t\t\t\t\t\t<div class=\"col-md-6\">\n");
      out.write("\t\t\t\t\t\t\t<select class=\"form-control input-xs\" data-bind=\"options: $root.useYnSelectOptions, optionsText:'text', optionsValue:'value', value: useYn ,optionsCaption: '전체'\" ></select>\n");
      out.write("\t\t\t\t\t\t</div>\n");
      ...
      out.write("\t\t\t</div>\n");
      out.write("\t\t\t<!-- 버튼  -->\n");
      out.write("<!-- \t\t\t<div class=\"text-right\" data-bind=\"visible: isEditMode\" style=\"float: left;\">\n");
      out.write("\t\t\t\t<button type=\"button\" class=\"btn btn-warning btn-xs\"><b><i class=\"icon-loop3\"></i></b> 공통코드변경</button>\n");
      out.write("\t\t\t</div> -->\n");
      out.write("\t\t\t<div class=\"text-right\" data-bind=\"visible: isCreateMode\" style=\"padding-top: 10px;\" >\n");
      ...
      out.write("\t\t\t</div>\n");
      out.write(" \t\t\t<div class=\"text-right\" data-bind=\"visible: isEditMode\" style=\"padding-top: 10px;\">\n");
      out.write("\t\t\t\t<button type=\"button\"   class=\"btn btn-xs\" data-bind=\"click:cancel\"><b><i class=\"icon-cross\"></i></b> 닫기</button>\n");
      ...
      out.write("\n");
      out.write("<script type=\"text/javascript\">\n");
      out.write("\tsetPageLocation(\"system/commoncodemng\", \"공통코드관리\");\n");
      out.write("\n");
      ...
      out.write("\tsrc=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("/app/system/commoncodemng/commoncodemng.js\"></script>\n");
      out.write("\n");
