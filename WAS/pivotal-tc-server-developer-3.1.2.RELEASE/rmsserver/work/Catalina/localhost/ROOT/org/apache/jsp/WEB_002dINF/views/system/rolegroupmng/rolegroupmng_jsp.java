 ...
 * Generated at: 2019-03-08 05:50:01 UTC
 * Note: The last modified time of this file was set to
 *       the last modified time of the source file after
 *       generation to assist with modification tracking.
 */
package org.apache.jsp.WEB_002dINF.views.system.rolegroupmng;
...
if(!Boolean.TRUE.equals(pageContext.getAttribute("pageContextJavaScriptIncluded"))) {
	pageContext.setAttribute("pageContextJavaScriptIncluded", Boolean.TRUE);
      ...
      out.write("\t\t\t\t\t<label class=\"control-label text-right\">권한그룹코드</label>\n");
      out.write("\t\t\t\t\t<input type=\"text\" class=\"form-control input-xs\" placeholder=\"권한그룹코드\" data-bind=\"value: searchRolegroupCode\">\n");
      out.write("\t\t\t\t</div>\n");
      out.write("\t\t\t\t<div class=\"col-md-3\">\n");
      out.write("\t\t\t\t\t<label class=\"control-label text-right\">권한그룹명</label>\n");
      out.write("\t\t\t\t\t<input type=\"text\" class=\"form-control input-xs\" placeholder=\"권한그룹명\" data-bind=\"value: searchRolegroupName\">\n");
      out.write("\t\t\t\t</div>\n");
      ...
      out.write("\t\t\t\t\t\t<span class=\"col-md-8\"><i class=\"icon-lock5 position-left\"></i> 권한그룹 정보</span>\n");
      out.write("\t\t\t\t\t</legend>\n");
      out.write("\t\t\t\t\t<div class=\"col-md-6\">\n");
      out.write("\t\t\t\t\t\t<div class=\"form-group\">\n");
      out.write("\t\t\t\t\t\t\t<label for=\"rolegroupCode\" class=\"col-md-4 control-label text-right\">권한그룹코드 <span class=\"text-danger\">*</span></label>\n");
      out.write("\t\t\t\t\t\t\t<div class=\"col-md-8\">\n");
      out.write("\t\t\t\t\t\t\t\t<input type=\"text\" id=\"rolegroupCode\" class=\"form-control input-xs\" name=\"rolegroupCode\" data-bind=\"value: rolegroupCode, enable:$parent.isCreateMode\">\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t<div class=\"form-group\">\n");
      out.write("\t\t\t\t\t\t\t<label for=\"rolegroupName\" class=\"col-md-4 control-label text-right\">권한그룹명 <span class=\"text-danger\">*</span></label>\n");
      out.write("\t\t\t\t\t\t\t<div class=\"col-md-8\">\n");
      out.write("\t\t\t\t\t\t\t\t<input type=\"text\" id=\"rolegroupName\" class=\"form-control input-xs\" name=\"rolegroupName\" data-bind=\"value: rolegroupName\">\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t</div>\n");
      ...
      out.write("\t\t\t\t\t<div class=\"col-md-6\">\n");
      out.write("\t\t\t\t\t\t<div class=\"form-group\">\n");
      out.write("\t\t\t\t\t\t\t<label class=\"col-md-4 control-label text-left\" for=\"roleList\">연결된 권한코드</label>\n");
      out.write("\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t<div class=\"form-group\">\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t<span data-bind=\"text:roleCode + ' - ' + roleName\"></span>\n");
      out.write("\t\t\t\t\t\t\t\t\t</label>\n");
      out.write("\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t</div>\n");
      ...
      out.write("\n");
      out.write("<script type=\"text/javascript\">\n");
      out.write("\tsetPageLocation(\"system/rolegroupmng\");\n");
      ...
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("/app/system/rolegroupmng/rolegroupmng.js\"></script>");
